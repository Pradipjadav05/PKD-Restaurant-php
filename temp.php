            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-box">
                            <input type="text" name="name" id="form_name" placeholder="Name" required="required"
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-box">
                            <input type="text" name="mobile" id="phone" placeholder="contact no." required="required"
                                data-error="Phone number is required.">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-box">
                            <input type="number" name="person" id="no_of_persons" placeholder="No. Of persons"
                                required="required" data-error="Number of Person required." />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-box">
