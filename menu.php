                ...
                <div class="col-xs-12 col-sm-6">
                    <a href="menu/pizza.php">
                        <div class="menu-section">
                            ...
                            <center>
                                <div class="menu-item">
                                    <img src="./images/pizza.jpg" class="menu-item-product"
                                        style="height:400px ; width:400p">
                                </div>
                            </center>
                        </div>
                    </a>
                ...
                <div class="col-xs-12 col-sm-6">
                    <a href="menu/fastfood.php">
                        <div class="menu-section">
                            ...
                            <center>
                                <div class="menu-item">
                                    <img src="./images/fastfood.jpeg" class="menu-item-product"
                                        style="height:400px ; width:400p">
                                </div>
                            </center>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <a href="menu/burgger.php">
                        <div class="menu-section">
                            ...
                            <center>
                                <div class="menu-item">
                                    <img src="./images/burgger.jpg" class="menu-item-product"
                                        style="height:400px ; width:400p">
                                </div>
                            </center>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <a href="menu/dishes.php">
                        <div class="menu-section">
                            ...
                            <center>
                                <div class="menu-item">
                                    <img src="./images/1.jpg" class="menu-item-product" class="mnuimg"
                                        style="height:400px ; width:400p">
                                </div>
                            </center>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <a href="menu/juice.php">
                        <div class="menu-section">
                            ...
                            <center>
                                <div class="menu-item">
                                    <img src="./images/juice.jpg" class="menu-item-product"
                                        style="height:400px ; width:400p">
                                </div>
                            </center>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <a href="menu/colddrinks.php">
                        <div class="menu-section">
                            ...
                            <center>
                                <div class="menu-item">
                                    <img src="./images/calldrinks.jpg" class="menu-item-product" class="mnuimg"
                                        style="height:400px ; width:400p">
                                </div>
                            </center>
                        </div>
