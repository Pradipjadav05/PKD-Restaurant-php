    ...
    <section>
        <div class="container">
            ...
            <p>
                ...
                service restaurant brands – TIM HORTONS®, BURGER KING®, and POPEYES®. These independently operated
                brands
            ...
            <p>
                ...
                Core to our vision of building the most loved restaurant brands in the world are the values that guide
                our work,
            ...
            <p>
                <b>
                    <h3>Our Employee Value Proposition</h3>
                </b>
            <ul>
                <li><b>Big Dream:</b> are driven by a big dream, working
                    together to build the most loved restaurant brands in the world.</li>
                <li><b>Big Responsibility: </b> believe in quick service without compromises. That means quality, real
                    ingredients,
                    social purpose and accountability for what we put into the world.</li>
                <li><b>Growth:</b> We have over 27,000 locations in 100+ countries with plans to reach more than 40,000
                    locations in the coming years.
                    This growth, coupled with our culture of meritocracy, creates opportunities for all of us.</li>
                <li><b>Hard Working Good People: </b> attract diverse and driven talent, who are the owners of our
                    vision.
                    We are hard working people – and fundamentally good at our core.</li>
                <li><b>Hospitality Culture:</b> We get excited to welcome hundreds of millions of people to our
                    restaurants every
                    year – in all of the languages, countries and communities that we serve around the planet.</li>
                <li><b>Real Ownership:</b> We help our teams become actual owners of our business, with compensation
                    that allows us
                    to acquire substantial share ownership as our responsibilities and contributions grow. We are
                    trusted to own and deliver on our area of the business as partners – not just as employees.</li>
            </ul>
            </p>
                                        ...
                                        <div class="carousel-item text-center active">
                                            <div style="display: inline-block; margin:5%">
                                                <div class="img-box p-1 border rounded-circle m-auto">
                                                    <img class="d-block w-100 rounded-circle" src="./images/avt-img.jpg"
                                                        alt="">
                                                </div>
